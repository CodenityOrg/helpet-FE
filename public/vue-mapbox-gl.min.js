var Mapbox = (function (t, e) {
  ...
  function c(t, o) {
    void 0 === o && (o = {}), (o.name = o.name || t._componentTag || t.name)
    var n = t.prototype
    Object.getOwnPropertyNames(n).forEach(function (t) {
      if ("constructor" !== t)
        if (s.indexOf(t) > -1) o[t] = n[t]
        else {
    ...
    var u,
      ...
      d = l instanceof e ? l.constructor : e,
      v = d.extend(o)
    return (
      (function (t, e, o) {
  ...
  var f = "undefined" != typeof Reflect && void 0 !== Reflect.getMetadata
  function l(t) {
    return (
      void 0 === t && (t = {}),
      function (e, o) {
  ...
  var m = (function (t) {
    ...
    return (
      ...
      n([l({ required: !0 })], e.prototype, "accessToken", void 0),
      n([l({ required: !0 })], e.prototype, "mapOptions", void 0),
      n(
        [
          l({
            default: function () {
          ...
          function (t, e, o) {
            ...
            o.value = function () {
              for (var t = this, o = [], i = 0; i < arguments.length; i++)
                o[i] = arguments[i]
              var a = function (n) {
                  void 0 !== n && o.unshift(n),
                    t.$emit.apply(t, [r || e].concat(o))
                },
                s = n.apply(this, o)
              return (
                h(s)
  ...
  g._withStripped = !0
  const _ = (function (t, e, o, n, r, i, a, s, c, p) {
  ...
  var O,
    b = {
      install: (O = function (t) {
        O.installed || ((O.installed = !0), t.component("Mapbox", _))
      })
    },
    w = null
  return (
    "undefined" != typeof window && (w = window.Vue),
    w && w.use(b),
    (t.default = _),
    t
  )
