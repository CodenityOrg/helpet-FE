<template>
  <div class="NotificationMenu" v-click-outside="close">
    <div class="NotificationMenu__button">
      ...
      <a
        ...
        ><font-awesome-icon icon="bell" style="margin: 5px" />
        <span class="NotificationMenu__buttonItem">Notificaciones</span>
      </a>
    </div>
