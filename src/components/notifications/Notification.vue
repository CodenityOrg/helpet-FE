  ...
  <div>
    <div
      ...
      <div class="Notification__Profile">
        <img :src="this.sender.profile" alt="" />
      </div>
      <div class="Notification__Info">
        <span class="Notification__InfoText">
          <strong>{{ senderFullName }}</strong> ha encontrado una mascota
          parecida a la tuya! Haz click para ver!</span
        >
        <span class="Notification__InfoDate"
