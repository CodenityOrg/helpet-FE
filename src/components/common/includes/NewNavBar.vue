<template>
  <nav
    ...
    <div
      class="Navbar__triggerButton"
      :class="{ 'Navbar__triggerButton--left': showMenu }">
    ...
    <div
      @click="close"
      class="Navbar__menu"
      :class="{ 'Navbar__menu--show': showMenu }">
...
export default {
  components: {
    NotificationMenu: () =>
      import(
        /* webpackPrefetch: true */ "@/components/notifications/NotificationMenu.vue"
      )
  },
  computed: {
    ...mapState({
