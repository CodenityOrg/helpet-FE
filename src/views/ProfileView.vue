    ...
    <div class="wrapper">
      ...
      <div class="card mt-4">
        <div
          ...
          <div
            class="picture align-self-stretch border-right justify-content-center align-items-center d-none d-lg-flex">
      ...
      <FormErrors
        ...
        v-if="userLoaded"
        v-show="!areAllInputsValid">
        <ErrorMessage v-show="!isFirstNameValid" message="* Nombre requerido" />
        <ErrorMessage
