              ...
              <b-card class="rounded-lg mb-4 text-center">
                ...
                <a
                  ...
                  ><img
                    ...
                    alt="Codenity"
                    src="../../src/assets/codenity-logo.png"
                /></a>
              </b-card>
            </b-col>
            <b-col md="6" lg="12">
              <b-card class="rounded-lg text-center">
                <div class="d-flex justify-content-around">
                  <a
                    rel="noopener noreferrer"
                    title="Ir a la página de Facebook de Codenity"
                    class="social-button social-button--facebook rounded-circle m-2 color-white"
                    target="_blank"
                    href="https://www.facebook.com/codenity19/">
                    <div
                      class="rounded-circle w-100 h-100 d-flex justify-content-center align-items-center">
                      f
                    </div>
                  </a>
                  <a
                    rel="noopener noreferrer"
                    title="Ir al perfil de LinkedIn de Codenity"
                    class="social-button social-button--linkedin rounded-circle m-2 color-white"
                    target="_blank"
                  ...
                  <a
                    rel="noopener noreferrer"
                    title="Ir al canal de YouTube de Codenity"
                    class="social-button social-button--youtube rounded-circle m-2 color-white"
                    target="_blank"
                    href="https://www.youtube.com/channel/UC2DadiWRoeRgPGgzRGZ0g4g">
                    <div
                      class="rounded-circle w-100 h-100 d-flex justify-content-center align-items-center">
                      <BIconPlayFill
                        font-scale="1.5"
